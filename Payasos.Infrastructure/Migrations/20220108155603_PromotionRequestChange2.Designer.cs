...
namespace Payasos.Infrastructure.Migrations
{
    ...
    [Migration("20220108155603_PromotionRequestChange2")]
    partial class PromotionRequestChange2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payasos.Core.Entities.PromotionRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("EnglishExpertId")
                        .HasColumnType("text");

                    b.Property<bool>("EnglishPass")
                        .HasColumnType("boolean");

                    b.Property<bool>("HardSkillPass")
                        .HasColumnType("boolean");

                    b.Property<string>("HardSkillsExpertId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Payasos.Core.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Payasos.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasOne("Payasos.Core.Entities.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId");
            ...
            modelBuilder.Entity("Payasos.Core.Entities.PromotionRequest", b =>
                {
                    b.HasOne("Payasos.Core.Entities.AppUser", "EnglishExpert")
                        .WithMany()
                        .HasForeignKey("EnglishExpertId");

                    b.HasOne("Payasos.Core.Entities.AppUser", "HardSkillsExpert")
                        .WithMany()
